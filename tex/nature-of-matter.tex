...
\subsubsection*{Preparation}
Grind the solid clay to make a fine powder.
...
\item{Add about 1 mL of methylated spirit to the test tube and again shake vigorously.}
...
\subsubsection*{Results and Conclusions}
In the first experiment oil and water clearly form two layers because they are immiscible liquids. Upon addition of methylated spirit and shaking, the two liquids form an emulsion. The emulsion is not transparent, you cannot be seen in it.
...
Evaporation is a simple method to separate solutions where one chemical is more volatile than the other, for example a solution of salt in water.
...
\subsubsection*{Preparation}
Make a mixture by combing water, salt, sand and pebbles in a plastic bottle. Close the lid and shake.
...
\begin{center}
\def\svgwidth{250pt}
\input{./img/water-filter.pdf_tex}
...
\subsubsection*{Preparation}
Make a mixture of iodine and salt by adding half a teaspoon of iodine crystals to a teaspoon of salt.

\subsubsection*{Activity Procedure}
Heat the container holding the iodine/salt mixture gently over a heat source. Remove periodically from the flame and observe--iodine crystals should form on the top of the container. If no iodine crystals form, put a dish of cool water over the mouth of the heating vessel. Observe the bottom of the dish. 
...
\begin{center}
\def\svgwidth{200pt}
\input{./img/chromatography.pdf_tex}
...
\begin{center}
\def\svgwidth{250pt}
\input{./img/chromatography-alt.pdf_tex}
...
\subsubsection*{Preparation}
Construct a separatory funnel in the following way:
\begin{enumerate}
...
\subsubsection*{Clean Up Procedure}
Collect all the used materials, cleaning and storing items that will be used later. Kerosene should not be disposed. Put it in a well-labelled bottle and store for later use.
...
\subsubsection*{Preparation}
Make an iodine solution by dissolving one part iodine for five parts water.
...
\subsubsection*{Preparation Procedure}
Break the steel wool into small piece.
