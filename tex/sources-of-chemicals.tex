...
The formation of a white precipitate -- lead sulfate -- confirms presence of lead.\\
Note: ammonia solution is also called ammonium hydroxide 
...
\subsection*{Calcium hydroxide (Lime water)}
Formula: \ce{Ca(OH)2}\\
...
\subsection*{Dilute sulphuric acid}
...
\begin{center}
\def\svgwidth{250pt}
\input{./img/hydrogen-materials.pdf_tex}
...
\begin{center}
\def\svgwidth{300pt}
\input{./img/hydrogen-balloon.pdf_tex}
...
burns skin, 
and can blind if it gets into the eyes\\
